...
export function DebtSection() {
  return (
    <Section id="debt" variant="dark">
      <Wrap>
        <Reveal>
          <Eyebrow accent="clay">Part 08 · The costs attention left</Eyebrow>
        </Reveal>
        <Reveal>
          <H2>Every token attends to every token — now a liability.</H2>
        </Reveal>
        <Reveal>
          <Lede>
            The paper solved training-time parallelism and left two lasting problems:{' '}
            ...
            years of systems research has gone toward addressing these two costs.
          </Lede>
        </Reveal>
        ...
        <div className="mt-10 grid gap-[18px] sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Reveal className="h-full" delay={0.05}>
            <FixCard tag="fix · move bytes smarter" accent="sky" title="FlashAttention" slugs={['kv-compression']}>
              Attention was never compute-bound — it was limited by memory traffic. Tile the
          ...
          <Reveal className="h-full" delay={0.1}>
            <FixCard tag="fix · attend less" accent="sky" title="Sparse attention" slugs={['linear-attention']}>
              ...
              MoBA — 2025) cut n² to near-linear on the assumption that most token pairs are
              irrelevant.
            </FixCard>
          </Reveal>
          <Reveal className="h-full">
            ...
            >
              ...
              — recurrence, redesigned. Production models now ship as{' '}
          ...
          <Reveal className="h-full" delay={0.05}>
            <FixCard tag="fix · guess then check" accent="olive" title="Speculative decoding" slugs={['twotower']}>
              ...
              faster. The 2017 parallelism idea, applied to generation.
            </FixCard>
          </Reveal>
          <Reveal className="h-full" delay={0.1}>
        ...
        <Reveal className="mt-10">
          <div className="border-clay rounded-[14px] border-[1.5px] bg-[linear-gradient(135deg,color-mix(in_srgb,var(--color-clay)_9%,var(--color-carddark)),var(--color-carddark)_55%)] px-8 py-9">
            <Tag accent="clay">Cost №2 · autoregression itself — a 2026 example</Tag>
            ...
            <p className="mt-5 text-[15px] italic text-(--note)">
              Every cost on this page, addressed in one artifact: SSM layers against the quadratic
              cost, MoE against the FLOPs cost, diffusion against the sequential cost — and still
              six attention layers it depends on.
            </p>
